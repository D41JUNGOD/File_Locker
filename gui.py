...
class Main_Window(QMainWindow, form_class):
    ...
    def initUI(self):
        self.setWindowIcon(QIcon('ui/image/folder.png'))

        pixmap = QPixmap("ui/image/background.jpg")
        self.label.setPixmap(pixmap)

        self.setStyleSheet(appStyle)
        self.pushButton_1.setIcon(QIcon('ui/image/locked_file.png'))
        self.pushButton_1.setIconSize(QSize(40, 40))
        layout = QVBoxLayout(self)
        layout.addWidget(self.pushButton_1)

        self.pushButton_2.setIcon(QIcon('ui/image/unlocked_file.png'))
        self.pushButton_2.setIconSize(QSize(40, 40))
        layout = QVBoxLayout(self)
        layout.addWidget(self.pushButton_2)

        self.pushButton_3.setIcon(QIcon('ui/image/search_file.png'))
        self.pushButton_3.setIconSize(QSize(40, 40))
        layout = QVBoxLayout(self)
        layout.addWidget(self.pushButton_3)

        self.pushButton_4.setIcon(QIcon('ui/image/exit.png'))
    ...
    def btn_clicked_3(self):
        ...
        result.exec()
'''
form_class = uic.loadUiType("ui/File_upload.ui")[0]
